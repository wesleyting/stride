...
export function DesktopNavigation({ footer }: { footer?: React.ReactNode }) {
  ...
  return (
    <aside className="hidden h-full min-h-0 w-52 shrink-0 flex-col overflow-y-auto border-r border-stone-200 bg-stone-50 px-3 py-5 md:flex md:overscroll-contain xl:w-56">
      <Link
        href="/"
