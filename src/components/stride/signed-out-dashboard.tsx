...
import { AuthPromptModal } from "@/components/stride/auth-prompt-modal";
        ...
        <main className="min-w-0 flex-1 px-4 py-7 sm:px-7 sm:py-9">
          ...
          <section className="mt-8" aria-labelledby="guest-pinned-heading">
            ...
            <div className="mt-4 rounded-xl border border-dashed border-stone-300 bg-stone-50 px-5 py-10 text-center sm:py-14">
              ...
              <p className="mx-auto mt-1 max-w-sm text-sm leading-6 text-stone-500">Start with a name. Everything else can be added when it becomes useful.</p>
              <div className="mt-4 flex justify-center"><AuthPromptModal /></div>
            </div>
          </section>
        </main>
    </AppFrame>
