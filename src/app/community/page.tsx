...
import { ChevronRight, LockKeyhole, Trophy, UsersRound } from "lucide-react";
import { signOutAction } from "@/app/actions";
import { AppFrame } from "@/components/stride/app-frame";
import { ProfileSettingsModal } from "@/components/stride/profile-settings-modal";
...
export default async function CommunityPage() {
  ...
  const [ownProfileResult, profilesResult] = await Promise.all([
    supabase.from("profiles").select("username, display_name, bio, is_public").eq("user_id", user.id).maybeSingle(),
